...
public class ResourcesHandler {
	...
	public static String getPromptByName(String name) {
		return getPromptByName(name, Map.of());
	}
	...
	public static String getAtdpExtractorPrompt(String name, String userText) {
		return getPromptByName(name, Map.of("USER_TEXT", userText));
	}
